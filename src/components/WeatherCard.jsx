...
export function WeatherCard() {
  return (
    <div className="flex flex-col  rounded-xl text-slate-600 bg-slate-100 p-5 ">
      <div className="flex justify-between flex-wrap">
        <div className="">
          <p className="text-primary-400 text-xs">Feb 25, 09:57am</p>
          <p className="font-bold text-2xl">London</p>
          <div>
            <p className="font-semibold text-6xl mt-4">5°C</p>
          </div>
        </div>
        <div className="">
          <svg
